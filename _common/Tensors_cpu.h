/* Tensors_cpu.h  -- header for interface functions to the kernels
 defined in /besfs/groups/psip/psipgroup/user/xiongxa/GamEtaPi0Pi0/Alg_gg_xl/GPUPWA/gpupwa2.1_1/GPUPWA/Tensors.cl, the corresponding binaries are in binfiles/Tensors_cpu.bin
